...
ls(char *path)
{
  ...
  ca:	e8 12 05 00 00       	call   5e1 <open>
 ...
 102:	e8 f2 04 00 00       	call   5f9 <fstat>
...
stat(char *n, struct stat *st)
{
 ...
 4c8:	e8 14 01 00 00       	call   5e1 <open>
 ...
 4e9:	e8 0b 01 00 00       	call   5f9 <fstat>
...
morecore(uint nu)
{
 ...
 9a0:	50                   	push   %eax
 9a1:	e8 73 fc ff ff       	call   619 <sbrk>
