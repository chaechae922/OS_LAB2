...
stat(char *n, struct stat *st)
{
 ...
 1ae:	e8 14 01 00 00       	call   2c7 <open>
 ...
 1cf:	e8 0b 01 00 00       	call   2df <fstat>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 391:	0f b6 91 20 0a 00 00 	movzbl 0xa20(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 4cb:	75 25                	jne    4f2 <printf+0xff>
          s = "(null)";
 4cd:	c7 45 f4 d5 07 00 00 	movl   $0x7d5,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 594:	a1 3c 0a 00 00       	mov    0xa3c,%eax
 ...
 65f:	a3 3c 0a 00 00       	mov    %eax,0xa3c
}
 664:	90                   	nop
 665:	c9                   	leave  
 666:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 686:	50                   	push   %eax
 687:	e8 73 fc ff ff       	call   2ff <sbrk>
 ...
 6bd:	83 c4 10             	add    $0x10,%esp
  return freep;
 6c0:	a1 3c 0a 00 00       	mov    0xa3c,%eax
}
 6c5:	c9                   	leave  
 6c6:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 6d9:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 6dc:	a1 3c 0a 00 00       	mov    0xa3c,%eax
 6e1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 6e4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 6e8:	75 23                	jne    70d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 6ea:	c7 45 f0 34 0a 00 00 	movl   $0xa34,-0x10(%ebp)
 6f1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 6f4:	a3 3c 0a 00 00       	mov    %eax,0xa3c
 6f9:	a1 3c 0a 00 00       	mov    0xa3c,%eax
 6fe:	a3 34 0a 00 00       	mov    %eax,0xa34
    base.s.size = 0;
 703:	c7 05 38 0a 00 00 00 	movl   $0x0,0xa38
 70a:	00 00 00 
  }
 ...
 760:	a3 3c 0a 00 00       	mov    %eax,0xa3c
      return (void*)(p + 1);
 ...
 76b:	eb 3b                	jmp    7a8 <malloc+0xe1>
    ...
    if(p == freep)
 76d:	a1 3c 0a 00 00       	mov    0xa3c,%eax
