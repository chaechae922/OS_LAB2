...
main(int argc, char *argv[])
{
 ...
 165:	6a 00                	push   $0x0
 167:	50                   	push   %eax
 168:	e8 5f 04 00 00       	call   5cc <open>
...
stat(char *n, struct stat *st)
{
 ...
 4b3:	e8 14 01 00 00       	call   5cc <open>
 ...
 4d4:	e8 0b 01 00 00       	call   5e4 <fstat>
...
0000061c <uthread_init>:
SYSCALL(uthread_init)
 61c:	b8 18 00 00 00       	mov    $0x18,%eax
 621:	cd 40                	int    $0x40
 623:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 98b:	50                   	push   %eax
 98c:	e8 73 fc ff ff       	call   604 <sbrk>
