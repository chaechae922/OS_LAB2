...
runcmd(struct cmd *cmd)
{
  ...
  case EXEC:
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      58:	52                   	push   %edx
      59:	50                   	push   %eax
      5a:	e8 b9 0e 00 00       	call   f18 <exec>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      a7:	52                   	push   %edx
      a8:	50                   	push   %eax
      a9:	e8 72 0e 00 00       	call   f20 <open>
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2d3:	e8 48 0c 00 00       	call   f20 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     32c:	50                   	push   %eax
     32d:	e8 1e 0c 00 00       	call   f50 <chdir>
...
stat(char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     e07:	e8 14 01 00 00       	call   f20 <open>
  ...
  r = fstat(fd, st);
     ...
     e28:	e8 0b 01 00 00       	call   f38 <fstat>
...
00000f18 <exec>:
SYSCALL(exec)
     f18:	b8 07 00 00 00       	mov    $0x7,%eax
     f1d:	cd 40                	int    $0x40
     f1f:	c3                   	ret    

00000f20 <open>:
SYSCALL(open)
     f20:	b8 0f 00 00 00       	mov    $0xf,%eax
     f25:	cd 40                	int    $0x40
     f27:	c3                   	ret    

00000f28 <mknod>:
SYSCALL(mknod)
     f28:	b8 11 00 00 00       	mov    $0x11,%eax
     f2d:	cd 40                	int    $0x40
     f2f:	c3                   	ret    

00000f30 <unlink>:
SYSCALL(unlink)
     f30:	b8 12 00 00 00       	mov    $0x12,%eax
     f35:	cd 40                	int    $0x40
     f37:	c3                   	ret    

00000f38 <fstat>:
SYSCALL(fstat)
     f38:	b8 08 00 00 00       	mov    $0x8,%eax
     f3d:	cd 40                	int    $0x40
     f3f:	c3                   	ret    

00000f40 <link>:
SYSCALL(link)
     f40:	b8 13 00 00 00       	mov    $0x13,%eax
     f45:	cd 40                	int    $0x40
     f47:	c3                   	ret    

00000f48 <mkdir>:
SYSCALL(mkdir)
     f48:	b8 14 00 00 00       	mov    $0x14,%eax
     f4d:	cd 40                	int    $0x40
     f4f:	c3                   	ret    

00000f50 <chdir>:
SYSCALL(chdir)
     f50:	b8 09 00 00 00       	mov    $0x9,%eax
     f55:	cd 40                	int    $0x40
     f57:	c3                   	ret    

00000f58 <sbrk>:
SYSCALL(sbrk)
     f58:	b8 0c 00 00 00       	mov    $0xc,%eax
     f5d:	cd 40                	int    $0x40
     f5f:	c3                   	ret    

00000f60 <sleep>:
SYSCALL(sleep)
     f60:	b8 0d 00 00 00       	mov    $0xd,%eax
     f65:	cd 40                	int    $0x40
     f67:	c3                   	ret    

00000f68 <getpid>:
SYSCALL(getpid)
     f68:	b8 0b 00 00 00       	mov    $0xb,%eax
     f6d:	cd 40                	int    $0x40
     f6f:	c3                   	ret    

00000f70 <uthread_init>:
SYSCALL(uthread_init)
     f70:	b8 18 00 00 00       	mov    $0x18,%eax
     f75:	cd 40                	int    $0x40
     f77:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12df:	50                   	push   %eax
    12e0:	e8 73 fc ff ff       	call   f58 <sbrk>
